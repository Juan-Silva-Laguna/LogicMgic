...
class Nivel1(ttk.Frame):
    def __init__(self, parent):
        super().__init__(parent)
        self.parent = parent
        self.nombre_label= tk.Label(parent, text="Bienvenido(a) a el Primer Nivel, en este nivel tendras que hacer algunas operaciones con total concentracion, para que podamos entrar a tu mente y lograr adivinar el misterioso numero que has pensado. ¿Estas listo(a)?", wraplength=150)
    ...
    def mostrarTexto1(self):
        ...
        self.nombre_label.place(x=110,y=40)
        self.btn.place(x=80,y=100)
    
    def mostrarTexto2(self):
        self.nombre_label.destroy()
        self.btn.destroy()
        self.nombre_label= tk.Label(self.parent, text="A el numero que pensaste sumale "+str(self.num1), wraplength=150)
