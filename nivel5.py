...
class Nivel5(ttk.Frame):
    def __init__(self, parent):
        super().__init__(parent)
        self.parent = parent
        self.nombre_label= tk.Label(parent, text="Bienvenido(a) a el Quinto Nivel, en este nivel tendras que hacer algunas operaciones con total concentracion, para que podamos entrar a tu mente y lograr adivinar el misterioso numero que has pensado. ¿Estas listo(a)?", wraplength=150)
    ...
    def mostrarTexto1(self):
        ...
        self.btn.destroy()
        self.nombre_label= tk.Label(self.parent, text="Piensa un numero", wraplength=150)
    ...
    def mostrarTexto2(self):
        self.nombre_label.destroy()
        self.btn.destroy()
        self.nombre_label= tk.Label(self.parent, text="A el numero que pensaste agregale un 0 la derecha ", wraplength=150)
    ...
    def mostrarTexto3(self):
        self.nombre_label.destroy()
        self.btn.destroy()
        multiplo = self.num1 * 9
        self.nombre_label= tk.Label(self.parent, text="Al resultado anterior restale "+str(multiplo), wraplength=150)
    ...
    def mostrarTexto4(self):
        self.nombre_label.destroy()
        self.btn.destroy()
        self.nombre_label = tk.Label(self.parent, text="Por favor Igresa el resultado", wraplength=150)
    ...
    def calcular(self):
        ...
        self.input1.destroy()
        total = int(entrada[:2])+int(entrada[2:])
        self.nombre_label = tk.Label(self.parent, text="Segun el procedimiento y si hiciste todas las operaciones con atención, podemos decir con total seguridad que el numero que pensaste es: "+str(total), wraplength=150)
